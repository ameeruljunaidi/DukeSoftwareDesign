...
public class QuakeEntry implements Comparable<QuakeEntry> {
    ...
    public int compareTo(QuakeEntry loc) {
        // Sort quake by magnitude first, from smallest to largest
        // Break ties (use == operator to determine magnitude are equal) by depth, from smallest (most negative) depth
        // to largest
